...
- User asks "show well interpretation results for WELL", then IMMEDIATELY call build_logplot with well=WELL and track_templates=GR,LLD,NPHI,INTERP1,INTERP2,FLAGS
